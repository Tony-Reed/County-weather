...
//Decode it to a multi-dimensional array
...
echo "<br>" . "Currently: " . "$curTemp" . "&deg;" . "&mdash;" . "  ";
echo ($foreCast['currently']['summary']);
echo "<br>";

echo "High today:  " . round($foreCast['daily']['data'][0]['temperatureMax'],0,PHP_ROUND_HALF_UP) . "&deg" . "<br>";
